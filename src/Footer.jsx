      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center sm:text-left">
          ...
          <div>
            ...
            <p className="flex items-center justify-center sm:justify-start mb-2">
              <AiOutlineMail className="mr-2" />
              <a href="mailto:mbitahigh@gmail.com" className="underline">
                mbitahigh@gmail.com
              </a>
            </p>
            <p className="flex items-center justify-center sm:justify-start mb-4">
        ...
        {isFormOpen && (
          <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center z-50">
            <form onSubmit={handleFormSubmit} className="bg-white p-8 rounded-md shadow-lg w-full sm:w-96">
        ...
        <div className="mt-8 border-t border-gray-700 pt-4 text-center text-sm">
          <p>
            &copy; {currentYear} Mbita High School. All rights reserved. Designed and Maintained by{" "}
